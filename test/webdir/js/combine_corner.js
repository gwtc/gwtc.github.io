...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:SEOBNRv4PHM'] = ['mass_1', 'mass_2', 'chirp_mass', 'symmetric_mass_ratio', 'ra', 'dec', 'geocent_time', 'phase', 'psi', 'luminosity_distance', 'log_likelihood', 'total_mass', 'mass_ratio', 'chi_eff', 'chi_p', 'tilt_1', 'tilt_2', 'phi_12', 'theta_jn', 'phi_jl', 'redshift', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'a_1', 'a_2'];
    list['C01:Mixed'] = ['total_mass_source', 'phi_jl', 'theta_jn', 'a_1', 'mass_1_source', 'mass_ratio', 'dec', 'symmetric_mass_ratio', 'luminosity_distance', 'tilt_1', 'ra', 'redshift', 'psi', 'chirp_mass', 'geocent_time', 'chirp_mass_source', 'a_2', 'tilt_2', 'phase', 'total_mass', 'mass_1', 'chi_p', 'phi_12', 'mass_2_source', 'log_likelihood', 'chi_eff', 'mass_2'];
    list['C01:IMRPhenomXPHM'] = ['a_1', 'a_2', 'chi_eff', 'chi_p', 'chirp_mass', 'dec', 'geocent_time', 'log_likelihood', 'luminosity_distance', 'mass_1', 'mass_2', 'mass_ratio', 'phase', 'phi_12', 'phi_jl', 'psi', 'ra', 'symmetric_mass_ratio', 'theta_jn', 'tilt_1', 'tilt_2', 'total_mass', 'redshift', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source'];
    ...
    var data = {}
    data['C01:SEOBNRv4PHM'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['C01:Mixed'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['C01:IMRPhenomXPHM'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
